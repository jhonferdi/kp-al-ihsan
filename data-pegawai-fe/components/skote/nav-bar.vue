      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          ...
          <router-link tag="a" to="/" class="logo logo-light">
            <span class="logo-sm">
              <img src="@/assets/images/logo-al-ihsan.png" alt height="40" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/logo-al-ihsan.png" alt height="40" />
            </span>
      ...
      <div class="d-flex">
        ...
        >
          ...
          <div class="p-2 border-top d-grid">
            <a
              class="btn btn-sm btn-link btn-block font-size-14 text-center"
        ...
        <b-dropdown v-if="user" right variant="black" toggle-class="header-item" menu-class="dropdown-menu-end">
          <template v-slot:button-content>
            <img v-if="user.pegawai.peg_images" class="rounded-circle header-profile-user"
              :src="user.pegawai.peg_images" alt="Avatar" />
            <img v-else class="rounded-circle header-profile-user" src="@/assets/images/logo-al-ihsan.png" style="" />
            <span class="d-none d-xl-inline-block ms-1">{{ user.pegawai.peg_nama_tanpa_gelar }}</span>
          ...
          <b-dropdown-item class="d-block" href="javascript: void(0);">
            <router-link tag="span" :to="{ name: 'settings.profile' }">
              <i class="bx bx-user font-size-16 align-middle me-1"></i>
              {{ $t("navbar.dropdown.henry.list.profile") }}
            </router-link>
          </b-dropdown-item>
          <b-dropdown-item href="javascript: void(0);">
            <router-link tag="span" :to="{ name: 'settings.password' }">
