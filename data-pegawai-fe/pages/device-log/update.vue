  ...
  <b-card title="Log Device">
    <b-container fluid>
      ...
      <b-row class="my-1">
        ...
        <b-col sm="6">
          <input type="text" class="form-control" v-model="form.device_uuid" disabled>
        </b-col>
      </b-row>
    </b-container>
  ...
  methods: {
    async getViewData(){
      try{
        ...
        let f1 = await axios.get("/device-logs/view/" + id);
