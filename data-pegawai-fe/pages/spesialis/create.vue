<template>
  <b-card title="Jenis Spesialis Baru" class="my-4">
    <br>
    <b-container fluid>
      <b-row class="my-2">
        <b-col sm="3">
        ...
        <b-col sm="3">
          <label for="input-subs">Sub Spesialis:</label>
        </b-col>
        <b-col sm="9">
    ...
    async save() {
      ...
      try {
        ...
        if (resp.success) {
          ...
          this.form.spesialis_nama = ''
          this.form.sub_spesialis_id = ''
