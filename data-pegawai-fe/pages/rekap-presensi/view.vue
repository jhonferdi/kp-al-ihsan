  ...
  <b-card title="Rekap Presensi">
    <b-container fluid>
      ...
      <b-row class="my-1">
        ...
        <b-col sm="6">
          <input type="text" class="form-control" v-model="form.log_sent_date_formatted" disabled>
        </b-col>
      </b-row>
      <b-row class="my-1">
        <b-col sm="12">
        ...
        <b-col sm="6">
          <input type="text" class="form-control" v-model="form.checkin_formatted" disabled>
        </b-col>
      </b-row>
      <b-row class="my-1">
        <b-col sm="12">
        ...
        <b-col sm="6">
          <input type="text" class="form-control" v-model="form.checkout_formatted" disabled>
        </b-col>
      </b-row>
      <b-row class="my-1">
        <b-col sm="12">
        ...
        <b-col sm="6">
          <input type="text" class="form-control" v-model="form.is_late_formatted" disabled>
        </b-col>
      </b-row>
    </b-container>
  ...
  methods: {
    async getViewData(){
      try{
        ...
        let f1 = await axios.get("/rekap-presensi/view/" + id + '/' + date);
        let data = f1.data.data;
        console.log(data);
        this.form = data;
        this.form.satuan_kerja_id = data.pegawai.satuan_kerja_id;
        this.form.is_late_formatted = data.is_late ? 'Terlambat' : 'Tepat Waktu';
    ...
    async save() {
      ...
      let url = "/rekap-presensi/update";
      
      await axios.post(url, {
          id: this.form.id,
          device_uuid: this.form.device_uuid
        })
        .then(({ data }) => {
          console.log(data);
          if (data.success) {
